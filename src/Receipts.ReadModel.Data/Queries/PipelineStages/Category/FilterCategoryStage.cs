...
namespace Receipts.ReadModel.Data.Queries.PipelineStages.Category
{
    internal static class FilterCategoryStage
    {
        internal static PipelineDefinition<Receipts.ReadModel.Entities.Category, BsonDocument> FilterCategories(
            this PipelineDefinition<Receipts.ReadModel.Entities.Category, BsonDocument> pipelineDefinition,
